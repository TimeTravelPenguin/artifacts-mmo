...
pub trait TasksApi: Send + Sync {
    ...
    async fn get_all_tasks_rewards_tasks_rewards_get<'page, 'size>(
        &self,
        page: Option<i32>,
        size: Option<i32>,
    ...
    async fn get_all_tasks_tasks_list_get<'min_level, 'max_level, 'skill, 'r_type, 'page, 'size>(
        &self,
    ...
    async fn get_task_tasks_list_code_get<'code>(
        &self,
        code: &'code str,
    ...
    async fn get_tasks_reward_tasks_rewards_code_get<'code>(
        &self,
        code: &'code str,
    ...
    async fn get_all_tasks_rewards_tasks_rewards_get<'page, 'size>(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DataPageDropRateSchema`")))),
            }
        } else {
    ...
    async fn get_all_tasks_tasks_list_get<'min_level, 'max_level, 'skill, 'r_type, 'page, 'size>(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::DataPageTaskFullSchema`")))),
            }
        } else {
    ...
    async fn get_task_tasks_list_code_get<'code>(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::TaskFullResponseSchema`")))),
            }
        } else {
    ...
    async fn get_tasks_reward_tasks_rewards_code_get<'code>(
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            match local_var_content_type {
                ...
                ContentType::Unsupported(local_var_unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{local_var_unknown_type}` content type response that cannot be converted to `models::RewardResponseSchema`")))),
            }
        } else {
